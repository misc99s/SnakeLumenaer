...
public abstract class Game {
     ...
     */
    /**if gameOver = true then sets the background to the Gameover screen*/
    public void nextGameStep() {
        if(gameOver && once) {
            ...
            /**makes the snake move at the assigned speed. the higher snakespeed is, the slower the snake*/
            if(counter % Snake.getSnakeSpeed() == 0) {
                ...
                /**adds the new head/snakepart when the snake eats a fruit*/
                if(Snake.getHead()) {
                ...
                /**normalizes snakeSpeed after time*/
                ...
                /**if there are less than 5 fruits on the grid, some more get added(could happen if fruits are eaten too quickly)*/
